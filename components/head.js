...
const HeadComponent = () => (
  <Head>
    ...
    <meta
      name="description"
      content={brand.maskulino.desc}
    />
    {/* Favicon */}
    <link rel="icon" href="/favicons/favicon_main.ico" />
    ...
    <meta property="twitter:image:src" content="/images/maskulino-logo.png" />
    <meta property="og:url" content={brand.maskulino.url} />
    <meta property="og:title" content={brand.maskulino.desc} />
    <meta
      property="og:description"
      content={brand.maskulino.desc}
    />
    <meta name="twitter:site" content={brand.maskulino.url} />
    <meta name="twitter:card" content="summary_large_image" />
    <meta name="twitter:image" content={brand.maskulino.img} />
    <meta property="og:image" content={brand.maskulino.img} />
